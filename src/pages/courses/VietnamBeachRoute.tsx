                      ...
                      <div className="grid md:grid-cols-2 gap-8 items-center">
                        <div className="order-2 md:order-1">
                          ...
                          <div className="space-y-4 text-muted-foreground leading-relaxed">
                            ...
                            <p>
                              푸른 남중국해를 왼편에 두고 완만한 곡선을 따라 달리다 보면, 오토바이 대신 <span className="text-primary font-semibold">'두 다리로 바람을 가르며 달리는 자전거의 자유'</span> 를 온전히 느낄 수 있습니다.
                            </p>
                            <p>
                              길 자체의 난이도는 중급 수준으로, 오르막 10~15분, 이후 완만한 내리막과 바다 뷰가 이어져 라이딩 초보자에게도 충분히 도전 가능한 코스입니다.
                            </p>
                          </div>
                        </div>
